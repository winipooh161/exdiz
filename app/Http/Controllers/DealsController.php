...
public function dealUser()
{
            ...
            public function storeDeal(Request $request)
            {
                ...
                if ($request->hasFile('avatar') && $request->file('avatar')->isValid()) {
                    ...
                    $avatarPath = $request->file('avatar')->storeAs(
                        $avatarDir, 'avatar.' . $avatarExt, 'public'
                    );
    ...
    public function updateDeal(Request $request, $id)
    {
        ...
        foreach ([
            'name','client_phone','status','completion_responsible','stage',
            'coordinator_score','client_city','total_sum','measuring_cost','project_budget',
            'created_date','deal_end_date','client_info','payment_date','package','rooms_count',
