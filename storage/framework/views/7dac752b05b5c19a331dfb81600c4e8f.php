...
<div class="block_create">
    <form action="<?php echo e(route('estimate.createcoefs')); ?>" class="create-step_1-form" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\OSPanel\domains\dlk\resources\views\estimate\createCoefs.blade.php ENDPATH**/ ?>