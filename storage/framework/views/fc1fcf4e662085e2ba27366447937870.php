...
<div class="support-container">
    ...
    <div class="chat-list">
        ...
        <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="chat-item">
                ...
                <a href="<?php echo e(route('support.chats', $ticket->id)); ?>">Открыть чат</a>
            </div>
    ...
    <div class="chat-window">
        <?php if(isset($selectedTicket) && $selectedTicket): ?>
            <h1>Чат <?php echo e($selectedTicket->title); ?></h1>
            <div class="messages">
...
<?php /**PATH C:\OSPanel\domains\dlk\resources\views\support\module\chats.blade.php ENDPATH**/ ?>