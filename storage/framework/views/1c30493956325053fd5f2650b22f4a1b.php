...
<?php if(isset($dealChat) && $dealChat): ?>
    <div class="chat-container single-deal-chat">
        <div class="chat-box">
            <div class="chat-header">
                Групповой чат сделки: <?php echo e($dealChat->name); ?>
            ...
            <div class="chat-input" style="position: relative;">
                ...
                <button id="send-message">
                    <img src="<?php echo e(asset('/storage/icon/send.svg')); ?>" alt="Отправить" width="24" height="24">
                </button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // ----------------------------------
        const currentChatId   = "<?php echo e($dealChat->id); ?>";
...
<?php else: ?>
    <div class="chat-container">
        ...
        <div class="user-list" style="z-index: 41;">
            ...
            <ul id="chat-list">
                <?php if(isset($chats) && count($chats)): ?>
                    <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li data-chat-id="<?php echo e($chat['id']); ?>" data-chat-type="<?php echo e($chat['type']); ?>"
                            style="position: relative; display: flex; align-items: center; margin-bottom: 10px; cursor: pointer;">
                            <div class="user-list__avatar">
                                <img src="<?php echo e(asset($chat['avatar_url'])); ?>" alt="<?php echo e($chat['name']); ?>">
                            </div>
                            <div class="user-list__info" style="margin-left: 10px; width: 100%;">
                                <h5>
                                    ...
                                    <?php if($chat['unread_count'] > 0): ?>
                                        <span class="unread-count"><?php echo e($chat['unread_count']); ?></span>
                                    <?php endif; ?>
                                </h5>
                            </div>
                        </li>
    ...
    <script>
        ...
        function playSoundNotification() {
            const audio = new Audio('<?php echo e(asset("sounds/notification.mp3")); ?>');
