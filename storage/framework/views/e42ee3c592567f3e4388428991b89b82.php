<div class="smets wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="1.5s" id="smets">
    <h1>Создание сметы</h1>
        ...
        <form action="<?php echo e(route('estimate.save')); ?>/<?php echo e($estimate->id); ?>" class="create-step_2-form wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="1.5s" method="post">
            <?php echo csrf_field(); ?>
            <div class="block_one">
                    ...
                    <?php if($service->type == 'stage'): ?>
                        <div class="row service-row label__categories">
                            ...
                            <input type="hidden" id="stage-<?php echo e($service->id); ?>" name="stage-<?php echo e($service->id); ?>"
                                ...
                                <h3 hidden  class="service-h3 none" id="counter-<?php echo e($service->id); ?>" hidden>
                                    <?php echo e($stage); ?> </h3>
                        </div> 
                    <?php endif; ?>
                                ...
                                <div class="div_gop content-<?php echo e($service->id); ?>" id="div_gop" >
                                    <div class="col-12 service-col-12  hp_input_prise">
                                        <input type="checkbox" id="check-<?php echo e($innerService->id); ?>"
                                            ...
                                            onchange="toggleElements('check-<?php echo e($innerService->id); ?>', 'service-<?php echo e($innerService->id); ?>', 'counter-<?php echo e($innerService->id); ?>')">
                                        <label for="check-<?php echo e($innerService->id); ?>"><p><?php echo e($innerService->info); ?>

                                            (<?php echo e($innerService->substage); ?>)   </p><div class="abs_hp_input_prise">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M16.9457 2.49381L15.3374 0.875058C14.9343 0.487649 14.3983 0.271484 13.8409 0.271484C13.2835 0.271484 12.7476 0.487649 12.3444 0.875058L1.602 11.6813C1.52258 11.7626 1.46675 11.8642 1.44055 11.9751L0.198652 16.9751C0.172367 17.0796 0.173422 17.1893 0.201713 17.2933C0.230004 17.3974 0.284569 17.4923 0.360099 17.5688C0.418121 17.6267 0.486932 17.6726 0.562587 17.7037C0.638242 17.7348 0.719253 17.7505 0.800974 17.7501C0.85047 17.7561 0.900506 17.7561 0.950002 17.7501L5.9176 16.5001C6.02779 16.4737 6.12871 16.4175 6.20945 16.3376L16.9457 5.50631C17.1428 5.30885 17.2992 5.07414 17.406 4.81565C17.5127 4.55716 17.5677 4.27999 17.5677 4.00006C17.5677 3.72013 17.5127 3.44296 17.406 3.18447C17.2992 2.92598 17.1428 2.69127 16.9457 2.49381ZM2.91841 12.1251L11.3571 3.63131L14.2073 6.50006L5.76858 14.9938L2.91841 12.1251ZM2.37819 13.3751L4.52668 15.5376L1.65168 16.2688L2.37819 13.3751ZM16.0701 4.62506L15.0828 5.61881L12.2327 2.75006L13.22 1.75631C13.3881 1.59723 13.6102 1.50866 13.8409 1.50866C14.0717 1.50866 14.2938 1.59723 14.4619 1.75631L16.0701 3.37506C16.234 3.54128 16.3259 3.76593 16.3259 4.00006C16.3259 4.23419 16.234 4.45883 16.0701 4.62506Z" fill="#424242"/>
                                                    </svg>
                                            </div>
                                        ...
                                        <input type="hidden" id="service-<?php echo e($innerService->id); ?>"
                                            name="service-<?php echo e($innerService->id); ?>" data-price='<?php echo e($price); ?>'
                            ...
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $innerService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($innerService->type == 'service' && $innerService->stage == $stage): ?>
                                    <?php
                                        $price = $innerService->price * $estimate->coefficient * (1 - $estimate->discount / 100);
                                    ?>
                                   <div class="flex_wrap service-flex_wrap reda"  name="<?php echo e($innerService->unit); ?> "
                                    id="counter-<?php echo e($innerService->id); ?>">
                                    <p id="service-<?php echo e($innerService->id); ?>" class="create-service_input"
                                        data-price='<?php echo e($price); ?>'>
                                        Стоимость: <span id="price-<?php echo e($innerService->id); ?>"
                                            class="create-service_input"> <span
                                                class="create-service_input"><?php echo e($price); ?></span></span>
                                    </p>
                                    <input type="text"
                                        name="counter-<?php echo e($innerService->id); ?>_info-<?php echo e($innerService->info); ?>, <?php echo e($innerService->unit); ?> "
                                        id="counter-<?php echo e($innerService->id); ?>" class="create-service_input-data"
                                        placeholder="Количество"
                                        oninput="updatePrice(<?php echo e($innerService->id); ?>, <?php echo e($price); ?>)"
                                         value='0'> <span
                                        class="create-input_service-span"><?php echo e($innerService->unit); ?></span>
                                </div>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        let serverData = <?php echo json_encode($oldServises); ?>;
...
<?php /**PATH C:\OSPanel\domains\dlk\resources\views\estimate\create.blade.php ENDPATH**/ ?>