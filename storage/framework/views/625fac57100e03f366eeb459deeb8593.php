<div class="ponel__body ">
    <div class="ponel__ul">
        ...
        <li>
            <button id="toggle-panel" class="toggle-btn">☰<span>Свернуть меню</span></button>
        </li>
        <?php if(Auth::user()->status == 'admin' ): ?>
        <li>
            <button onclick="location.href='<?php echo e(url('/admin')); ?>'">
                <img src="/storage/icon/admin.svg" alt=""> <span>ADMIN</span>
            </button>
        </li>
    ...
    <?php endif; ?>
        ...
        <li>
            <button onclick="location.href='<?php echo e(url('/profile')); ?>'" id="step-7">
                <img src="/storage/icon/profile.svg" alt=""><span>Мой аккаунт</span>
            </button>
        </li>
