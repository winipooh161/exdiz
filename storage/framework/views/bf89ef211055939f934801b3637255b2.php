        ...
        <tr>
            ...
            <td>
                <select name="status" required>
                    <option value="active" <?php echo e($brief->status == 'active' ? 'selected' : ''); ?>>Активный</option>
                    <option value="inactive" <?php echo e($brief->status == 'inactive' ? 'selected' : ''); ?>>Неактивный</option>
