...
<form id="create-deal-form" action="<?php echo e(route('deals.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
        ...
        <div class="form-group-deal">
            ...
            <select id="coordinator_id" name="coordinator_id" class="form-control">
                ...
                <?php $__currentLoopData = $coordinators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($coord->id); ?>"><?php echo e($coord->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
    </fieldset>
    ...
    <input type="date" id="project_end_date" name="project_end_date" class="form-control">
        ...
        <div class="form-group-deal">
            ...
            <select id="visualizer_id" name="visualizer_id" class="form-control">
                <option value="">-- Не выбрано --</option>
                <?php $__currentLoopData = $visualizers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visualizer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
